...
class FarmLandCard extends StatelessWidget {
  ...
  final TextEditingController totalFLandPriceController;

  FarmLandCard({
    Key? key,
    required this.pricePerYardController,
    required this.totalAreaInYardsController,
    required this.totalFLandPriceController,
  }) : super(key: key);
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      controller:
                          totalFLandPriceController, // Remove the underscore
                      decoration:
                          InputDecoration(labelText: 'Plot Total Price'),
                      validator: (value) {
                        if (value == null || value.isEmpty) {
