...
class VillaCard extends StatefulWidget {
  ...
  final TextEditingController totalVillaPriceController;
  ...
  VillaCard({
    ...
    required this.totalVillaPriceController,
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      controller: widget.totalVillaPriceController,
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(labelText: 'Road in feet'),
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'Please enter Access Road width in feet';
                        }
                        return null;
                      },
                      keyboardType: TextInputType.number,
